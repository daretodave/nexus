...
| `skills/bootstrap.md` + `claude/commands/bootstrap.md` | You plan to run `/bootstrap` as the setup executor (tokens-in to deployed app + ticking cloud loop). See `nexus/customization/bootstrap-automation.md`. |
